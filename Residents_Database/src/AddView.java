...
public class AddView extends JPanel implements ActionListener {
	...
	public AddView(ResidentDataBaseModel residentDataBaseModel) {
		...
		jcbGenderList.setSelectedItem(GenderPreference.OTHER);
		jcbBedList.setSelectedItem(Bed.TWO_BED);
		jcbMajorList.setSelectedItem(Major.NONE);
		jcbEnrollmentList.setSelectedItem(Enrollment.NONE);
		...
		jcbMindPety.setSelected(true);
		jcbMindPetn.setSelected(false);
		jlPetList.setSelectedValue(Pet.NONE, false);
		jcbWorkList.setSelectedItem(1);
		jcbNeatList.setSelectedItem(1);
		jcbPersonalityList.setSelectedItem(1);
		jcbSocialList.setSelectedItem(1);
		jcbSleepList.setSelectedItem(1);
		jlHobbyList.setSelectedValue(Hobby.OTHER, false);
		jlCharacteristicsList.setSelectedValue(Characteristic.OTHER, false);
		jlSeekedCharacteristicsList.setSelectedValue(Characteristic.OTHER, false);
		...
		tab.addTab("Roommates", null, jpMate, null);
	...
	public void registerAddResidentListener(ActionListener AddResidentListener) {
		jbtOK.addActionListener(AddResidentListener);
	}
