 ...
 * 
 * A TVNewsStory is composed of the date the story was broadcast,
 ...
 * TVNewsStory is created as a subclass of NewsStory.
 * However, TVNewsStory can implement getLengthInWords
...
public class TVNewsStory extends NewsStory {
	 ...
	 * pass them to the constructor for NewsStory and let it do the work.
	 * 
	 * @param date
	 ...
	 */
	public TVNewsStory(LocalDate date, String sourceName, int length, String topic, NewsMaker newsMaker1,
			NewsMaker newsMaker2) {
		super(date, sourceName, length, topic, newsMaker1, newsMaker2);
	}
	...
	/**
	 * Overrides the getLengthInWords method from NewsStory. Because 
	 * the inherent length measurement units for TV news stories are
