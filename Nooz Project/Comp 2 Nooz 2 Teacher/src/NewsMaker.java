 ...
 * <code>NewsMaker</code> consists of a name and a collection of news stories
 * that feature that <code>NewsMaker</code>. There is a special
 * <code>NewsMaker</code> with the name "None" that is used for news stories
 * that don't have at least two named <code>NewsMakers</code>.
 * </P>
 * 
 * @author Dean Hougen
 * @version 2.0
...
class NewsMaker implements Comparable<NewsMaker> {
	 ...
	 * <P>
	 * Note that <code>NewsStoryList</code> objects are mutable, so this really
	 ...
	 * <code>NewsMaker</code> object is referenced in the <code>NewsStory</code>
