...
public class Book implements Serializable{
	...
	private static final long serialVersionUID = 1321199203757427355L;
	...
	/**
	 * Writebook to file of choosing
	 * 
	 * @param filename
	 * 				Chosen file by programmer. Hard coded
	 * @param book
	 * 				Book that is being written
	 * @throws IOException
	 * 				If error in input or output, an exception is thrown
	 */
	public static void writeBook(String filename, Book book) throws IOException
	{
	...
	/**
	 * Read book from file as an object
	 * 
	 * @param filename
	 * 				Chosen file from user for input
	 * @return Book
	 * 				Book that has been read is returned
	 * @throws IOException
	 ...
	 */
	public static Book readBook(String filename) throws IOException, ClassNotFoundException
	{
