...
public class SeriesModel extends Series {
	...
	/**
	 * This allows the serialization to have an ID
	 */
	...
	/**
	 * A mutator method to replace an episode in the hashmap list.
	 * 
	 * This method is to notify any possible 
	 * listener of changes to the episode collection.
	 */
	@Override
	...
	/**
	 * A method that can access a file to get the saved episodes
	 * 
	 * This method is to notify any possible 
	 * listener of changes to the episode collection.
	 */
	@Override
	public void loadEpisodeMap() {
		try {
